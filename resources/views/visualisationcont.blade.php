                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row" id="graphe-pn">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="text-center">pn/{{ $graph['nom_produit'] }}-{{ $graph['nom_ligne'] }}-{{ $graph['date_production'] }}</h2>
                                            </div>
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_pn_{{ $id_produit }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-sag" style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="text-center">sag/{{ $graph['nom_produit'] }}-{{ $graph['nom_ligne'] }}-{{ $graph['date_production'] }}</h2>
                                            </div>
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_sag_{{ $id_produit }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-d03" style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="text-center">d03/{{ $graph['nom_produit'] }}-{{ $graph['nom_ligne'] }}-{{ $graph['date_production'] }}</h2>
                                            </div>
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_d03_{{ $id_produit }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-d05" style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="text-center">d05/{{ $graph['nom_produit'] }}-{{ $graph['nom_ligne'] }}-{{ $graph['date_production'] }}</h2>
                                            </div>
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_d05_{{ $id_produit }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-d09" style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="text-center">d09/{{ $graph['nom_produit'] }}-{{ $graph['nom_ligne'] }}-{{ $graph['date_production'] }}</h2>
                                            </div>
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_d09_{{ $id_produit }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-d10" style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="text-center">d10/{{ $graph['nom_produit'] }}-{{ $graph['nom_ligne'] }}-{{ $graph['date_production'] }}</h2>
                                            </div>
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_d10_{{ $id_produit }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-r02" style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="text-center">r02/{{ $graph['nom_produit'] }}-{{ $graph['nom_ligne'] }}-{{ $graph['date_production'] }}</h2>
                                            </div>
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_r02_{{ $id_produit }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-Titre" style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="text-center">Titre/{{ $graph['nom_produit'] }}-{{ $graph['nom_ligne'] }}-{{ $graph['date_production'] }}</h2>
                                            </div>
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_Titre_{{ $id_produit }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-Granulometre" style="display:none">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <h2 class="text-center">Granulometrie/{{ $graph['nom_produit'] }}-{{ $graph['nom_ligne'] }}-{{ $graph['date_production'] }}</h2>
                                            </div>
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_Granulometre_{{ $id_produit }}" width="400" height="200"></canvas>
                                                <script>
