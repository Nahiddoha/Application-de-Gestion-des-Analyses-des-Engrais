      ...
      <tbody>
        <tr class="border">
          ...
          <td class="border">
            ...
            <form action="{{ route('delete_resultatproduit', $resultatproduit['id_moy']) }}" method="POST">
              @csrf
              @method('DELETE')
              <button type="submit" class="btn btn-danger btn-sm">Delete</button>
            </form>
          </td>
          <td class="border"> <form action="{{ route('update_moyenne') }}" method="POST">
                @csrf
              
                <input type="hidden" name="id_moy" value="{{ $resultatproduit['id_moy'] }}">
