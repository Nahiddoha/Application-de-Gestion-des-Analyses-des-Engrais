...
<body>
    ...
    <div class="container" id="marg">
        ...
        <table class="table table-striped">
            <thead>
                <tr class="border">
                    <td colspan="3" class="border">Saiseur : {{ $resultatacide['saiseur'] }}</th>
                    <th colspan="3" class="border">Nom d'unite : {{ $resultatacide['nom_ligne'] }}</th>
                    <th colspan="3" class="border">Nom produit : {{ $resultatacide['nom_produit'] }}</th>
                    <th colspan="5" class="border">date de saisi : {{ $resultatacide['date_saisi'] }}</th>
                </tr>
                <tr>
