  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="container" id="marg">
        ...
        <table class="table table-striped">
            <thead>
                <tr class="border">
                    <td colspan="3" class="border" style="color:green">Saiseur : <strong>{{ $resultatmoyenne['saiseur'] }}</strong></td>
                    <td colspan="3" class="border" style="color:green">Nom d'unite : <strong> {{ $resultatmoyenne['nom_ligne'] }}</strong></td>
                </tr>

                <tr>
                    <td colspan="3" class="border" style="color:green">Nom produit : <strong> {{ $resultatmoyenne['nom_produit'] }}</strong></td>
                    <td colspan="5" class="border" style="color:green">date de saisi : <strong>{{ $resultatmoyenne['date_saisi'] }}</strong></td>
                </tr>
