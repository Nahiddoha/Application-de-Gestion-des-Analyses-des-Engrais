                            ...
                            <tbody>
                                <tr class="border">
                                    ...
                                    <td class="border">
                                        ...
                                        <form action="{{ route('delete_resultattsp', $resultattsp['id_moytsp']) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="btn btn-danger btn-sm">Delete</button>
                                        </form>
                                    </td>
                                    <td class="border"><a href="{{ route('update_moyennestsp', ['id' => $resultattsp['id_moytsp']]) }}" class="btn btn-success btn-sm">Modifier</a></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                                    ...
                                    <tr class="border">
                                        ...
                                        <td class="border">
                                            <form action="{{ route('update_moyennestsp') }}" method="POST">
                                                @csrf
                                                <input type="hidden" name="id_moytsp" value="{{ $resultattsp['id_moytsp'] }}">
