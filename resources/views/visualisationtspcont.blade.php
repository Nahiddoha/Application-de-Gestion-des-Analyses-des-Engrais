                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    <div class="row" id="graphe-Bouille">
                                        ...
                                        @foreach($graphe_par_produit_Bouille as $id_produit => $graph)
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <canvas id="chart_Bouille_{{ $id_tsp }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-SortieGranul" style="display:none">
                                        @if(isset($_GET['search_date']) && isset($_GET['nom_lign']))
                                        @foreach($graphe_par_produit_SortieGranul as $id_produit => $graph)
                                        @if($graph['date_production'] == $_GET['search_date'] && $graph['nom_ligne'] == $_GET['nom_lign'])
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_SortieGranul_{{ $id_tsp }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-TitreTsp" style="display:none">
                                        @if(isset($_GET['search_date']) && isset($_GET['nom_lign']))
                                        @foreach($graphe_par_produit_TitreTsp as $id_produit => $graph)
                                        @if($graph['date_production'] == $_GET['search_date'] && $graph['nom_ligne'] == $_GET['nom_lign'])
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_TitreTsp_{{ $id_tsp }}" width="400" height="200"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-GranulometreTsp" style="display:none">
                                        @if(isset($_GET['search_date']) && isset($_GET['nom_lign']))
                                        @foreach($graphe_par_produit_GranulometreTsp as $id_produit => $graph)
                                        @if($graph['date_production'] == $_GET['search_date'] && $graph['nom_ligne'] == $_GET['nom_lign'])
                                        <div class="row">
                                            <div class="col-md-12">
                                            ...
                                            @foreach($graph as $graphe)
                                            <div class="col-md-6">
                                                <canvas id="chart_GranulometreTsp_{{ $id_tsp }}" width="400" height="200"></canvas>
                                                <script>
