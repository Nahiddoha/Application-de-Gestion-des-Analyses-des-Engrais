...
Route::get('/authentification', [ControllerProjet::class, 'authentification'])->name('authentification');
Route::get('/inscription', [ControllerProjet::class, 'inscription'])->name('inscription');

Route::get('/accueil', [ControllerProjet::class, 'login'])->name('projet.login');
Route::post('/authentification', [ControllerProjet::class, 'store'])->name('use.store');
...
Route::get('/first_page', [ControllerDeconnexion::class, 'logout'])->name('logout');
...
Route::put('/affiche_moyennesproduits/{id}', [ControllerUpdate::class, 'update_moyennes'])->name('update_moy');
//update tsp
...
//analyste acide
Route::get('/afficher_acide', [ControllerTableau::class, 'AfficherAcide'])->name('AfficherAcide');
//controleur acide
Route::get('/cont_acides', [ControllerTableau::class, 'AfficherAcidecont'])->name('AfficherAcidecont');
//analyste moyenne
Route::get('/afficher_moyacides', [ControllerTableau::class, 'AfficherMoyacide'])->name('AfficherMoyacide');
//controleur moyenne
Route::get('/afficher_moyacide', [ControllerTableau::class, 'AfficherMoyacidecont'])->name('AfficherMoyacidecont');
