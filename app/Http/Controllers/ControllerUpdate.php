...
class ControllerUpdate extends Controller
{
    ...
    public function show_moyennes(Request $request)
    {
        ...
        return view('update_moyennes', ['moyenne' => $data]);
    }
    ...
    {   
        ...
        return redirect('/affiche_moyennesproduits')->with('success', 'Moyenne updated successfully.');
    }
    ...
    public function show_moyennestsp(Request $request)
    {
        ...
        return view('update_moyennetsp', ['moyennetsp' => $data]);
    }
...
//view indeterminer
    ...
    public function update_produit(Request $request)
    {
        ...
        $granulometre->sup_4_74 = $request->input('sup_4_74');
    ...
    public function update_acide(Request $request, $id)
    {
        ...
        return redirect('/affiche_acide')->with('success', 'Produit updated successfully.');
    }
    ...
    public function show_moyacide(Request $request)
    {
        ...
        return view('update_moyenneacide', [
            'moyenne' => $moyenne
        ]);
    }
    ...
    public function update_moyacide(Request $request, $id)
    {
        ...
        return redirect('/affiche_moyenneacide')->with('success', 'Produit updated successfully.');
    }
}
