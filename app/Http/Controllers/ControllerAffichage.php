...
class ControllerAffichage extends Controller
{
    ...
    public function chart()
    {
        ...
        $donnees_Granulometre = Granulometre::select('heure', 'sup_5', 'sup_4_74', 'sup_4', 'sup_3_15', 'sup_2_5', 'sup_2', 'sup_1', 'id_produit')
            ->get()
            ->toArray();
        ...
        foreach ($grouped_data_Granulometre as $id_produit => $donnees_produit) {
            ...
            $sup_4_74 = array_column($donnees_produit, 'sup_4_74');
        ...
        return view('visualisation', compact('graphe_par_produit_d03', 'graphe_par_produit_pn', 'graphe_par_produit_r02', 'graphe_par_produit_sag', 'graphe_par_produit_d05', 'graphe_par_produit_d09', 'graphe_par_produit_d10', 'graphe_par_produit_Titre', 'graphe_par_produit_Granulometre'));
    }
    ...
    public function chartcont()
    {
        ...
        return view('visualisationcont', compact('graphe_par_produit_d03', 'graphe_par_produit_pn', 'graphe_par_produit_r02', 'graphe_par_produit_sag', 'graphe_par_produit_d05', 'graphe_par_produit_d09', 'graphe_par_produit_d10', 'graphe_par_produit_Titre', 'graphe_par_produit_Granulometre'));
    }
    ...
    public function chartTsp()
    {
        ...
        return view('visualisationTsp', compact('graphe_par_produit_Bouille', 'graphe_par_produit_SortieGranul', 'graphe_par_produit_TitreTsp', 'graphe_par_produit_GranulometreTsp'));
    }
    ...
    public function chartTspcont()
    {
        ...
        return view('visualisationTspcont', compact('graphe_par_produit_Bouille', 'graphe_par_produit_SortieGranul', 'graphe_par_produit_TitreTsp', 'graphe_par_produit_GranulometreTsp'));
    }
    ...
    public function recupererDonneestsps()
    {
        ...
        $tsp_produits = DB::table('tsps_produits')->get();
...
// dd($donnees_par_tsp_et_par_heure);
    ...
    public function recupererDonneestsp()
    {
        ...
        return view('affiche_produittsp', ['donnees_par_tsp_et_par_heure' => $donnees_par_tsp_et_par_heure]);
    }
    ...
    {
        $donnees_par_tsp_et_par_heure = $this->recupererDonneestsps();
        return view('cont_produittsp', ['donnees_par_tsp_et_par_heure' => $donnees_par_tsp_et_par_heure]);
    }
    ...
    public function recupererDonneesproduit()
    {
        ...
        return view('affiche_produits', ['donnees_par_produit_et_par_heure' => $donnees_par_produit_et_par_heure]);
    }
    ...
    public function recupererDonneesproduitcont()
    {
        ...
        $donnees_par_produit_et_par_heure = $this->recupererDonneesproduits();
        return view('cont_produits', ['donnees_par_produit_et_par_heure' => $donnees_par_produit_et_par_heure]);
    }
    ...
    public function getResultatsmoyennetsp()
    {
        ...
        return view('affiche_moyennestsp', ['resultattsps' => $resultattsps]);
    }
    ...
    public function getResultatsmoyennetspcont()
    {
        ...
        $resultattsps = $this->getResultatsmoyennetsps();
        return view('cont_moyennestsp', ['resultattsps' => $resultattsps]);
    }
    ...
    public function getResultatsmoyenneproduit()
    {
        ...
        return view('affiche_moyennesproduits', ['resultatproduits' => $resultatproduits]);
    }
    //controleur
    public function getResultatsmoyenneproduitcont()
    {
        ...
        $resultatproduits = $this->getResultatsmoyenneproduits();
        return view('cont_moyennes', ['resultatproduits' => $resultatproduits]);
    }
