...
class ControllerTsp extends Controller
{
    ...
    public function ajouter_tsp_produit(Request $request)
    {
        ...
        if ($all_fields_filled) {
            ...
            return redirect()->route('ajouter_tsp_produit')->withInput($request->all())->withErrors($message);
        }
    }
    public function ajouter_moyenne_tsp()
    {
        return view('ajouter_moyenne_tsp');
    }
...
//delete
    ...
    public function deletemoyennetsp($id)
    {
        ...
        $entry->delete();
        return redirect()->back()->withErrors('success', 'The operation was successful.')->withInput();
    }
    //delete moyennes
    public function deletemoyenne($id)
    {
        ...
        $entry->delete();
        return redirect()->back()->withErrors('success', 'The operation was successful.');
    }
