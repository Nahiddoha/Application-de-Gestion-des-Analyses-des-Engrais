  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="d1">
        <table class="table table-striped">
            <form method="POST" action="<?php echo e(route('update_moy', ['id' => $moyenne->id_moy])); ?>">
                <?php echo csrf_field(); ?>
...
</html><?php /**PATH C:\xampp\htdocs\projet_tarik_doha\projet_tarik_doha\resources\views/update_moyennes.blade.php ENDPATH**/ ?>