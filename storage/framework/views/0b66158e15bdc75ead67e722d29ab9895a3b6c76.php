...
<header class="bg-light">
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="d1">
        ...
        <div class="c1">
            <form method="post" action="<?php echo e(route('ajouter_moyA')); ?>">
                <table class="table table-striped">
                    <?php echo csrf_field(); ?>
                    ...
                    <tr class="border">
                        ...
                        <td class="border"><input type="text" name="densite"></td>
                    </tr>
                    ...
                    <tr class="border">
                        ...
                        <td class="border"><input type="text" name="Tc"></td>
                    </tr class="border">
                    ...
                    <tr class="border">
                        ...
                        <td class="border"><input type="text" name="p2o5"></td>
                    </tr>
                    ...
                    <tr class="border">
                        ...
                        <td class="border"><input type="text" name="TS"></td>
                    </tr>
                    ...
                    <tr class="border">
                        ...
                        <td class="border"><input type="text" name="SO4"></td>
                    </tr>
                </table>
...
</html><?php /**PATH C:\xampp\htdocs\projet_tarik_doha\projet_tarik_doha\resources\views/MoyenneAcide.blade.php ENDPATH**/ ?>