...
<header class="bg-light">
  ...
  <div class="container" id="marg">
    ...
    <?php if($resultatproduit['date_saisi'] == $_GET['search_date'] && $resultatproduit['nom_ligne'] == $_GET['nom_lign']): ?>
    <table class="table table-striped">
      ...
      <tbody>
        <tr class="border">
          ...
          <td class="border"> <form action="<?php echo e(route('update_moyenne')); ?>" method="POST">
                <?php echo csrf_field(); ?>
              
                <input type="hidden" name="id_moy" value="<?php echo e($resultatproduit['id_moy']); ?>">
