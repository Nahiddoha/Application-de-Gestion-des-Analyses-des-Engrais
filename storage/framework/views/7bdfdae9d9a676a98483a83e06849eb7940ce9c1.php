  ...
  <nav class="navbar navbar-expand-lg navbar-light bg-light">
    ...
    <div class="d1">
        <table class="table table-striped">
            <form method="POST" action="<?php echo e(route('update_moy')); ?>">
                <?php echo csrf_field(); ?>
                <?php echo method_field('POST'); ?>
                <input type="hidden" name="id_produit" value="<?php echo e($moyenne->id_produit); ?>">
                <input type="hidden" name="id_moy" value="<?php echo e($moyenne->id_moy); ?>">
        ...
        <div class="c1">
            ...
            <table class="table table-striped">
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="ammonical" value="<?php echo e($moyenne->ammonical); ?>" required autofocus></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="p2o5" value="<?php echo e($moyenne->p2o5); ?>" required></td>
                </tr class="border">
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="p2o5_tot" value="<?php echo e($moyenne->p2o5_tot); ?>" required></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="p2o5_SE_C" value="<?php echo e($moyenne->p2o5_SE_C); ?>" required></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="h2o" value="<?php echo e($moyenne->h2o); ?>" required></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="zn" value="<?php echo e($moyenne->zn); ?>" required></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="s" value="<?php echo e($moyenne->s); ?>" required></td>
                </tr>
                <tr class="border">
                    <th class="border" id="prb">
                        <p> > 5</p>
                    </th>
                    <td class="border"><input type="text" name="sup_5" value="<?php echo e($moyenne->sup_5); ?>" required></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="sup_4_75" value="<?php echo e($moyenne->sup_4_75); ?>" required></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="sup_4" value="<?php echo e($moyenne->sup_4); ?>" required></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="sup_3_15" value="<?php echo e($moyenne->sup_3_15); ?>" required></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="sup_2_5" value="<?php echo e($moyenne->sup_2_5); ?>" required></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="sup_2" value="<?php echo e($moyenne->sup_2); ?>" required></td>
                </tr>
                ...
                <tr class="border">
                    ...
                    <td class="border"><input type="text" name="sup_1" value="<?php echo e($moyenne->sup_1); ?>" required></td>
                </tr>
            </table>
        </div>
...
</html><?php /**PATH C:\xampp\htdocs\projet_tarik_doha\projet_tarik_doha\resources\views/update_moyenne.blade.php ENDPATH**/ ?>