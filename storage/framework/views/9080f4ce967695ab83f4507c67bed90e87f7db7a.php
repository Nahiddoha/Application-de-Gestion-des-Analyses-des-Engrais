                                ...
                                <div class="col-md-8">
                                    <div class="row" id="graphe-Bouille">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <canvas id="chart_Bouille_<?php echo e($id_tsp); ?>" width="800" height="400"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-SortieGranul" style="display:none">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php $__currentLoopData = $graph; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $graphe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6">
                                                <canvas id="chart_SortieGranul_<?php echo e($id_tsp); ?>" width="800" height="400"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-TitreTsp" style="display:none">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php $__currentLoopData = $graph; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $graphe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6">
                                                <canvas id="chart_TitreTsp_<?php echo e($id_tsp); ?>" width="800" height="400"></canvas>
                                                <script>
                                    ...
                                    <div class="row" id="graphe-GranulometreTsp" style="display:none">
                                        ...
                                        <div class="row">
                                            ...
                                            <?php $__currentLoopData = $graph; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $graphe): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-6">
                                                <canvas id="chart_GranulometreTsp_<?php echo e($id_tsp); ?>" width="800" height="400"></canvas>
                                                <script>
...
</html><?php /**PATH C:\xampp\htdocs\projet_tarik_doha\projet_tarik_doha\resources\views/visualisationTsp.blade.php ENDPATH**/ ?>